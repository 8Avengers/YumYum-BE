...
export class BookmarkController {
  ...
  /*
      ...
      */
  @Put("/:collectionId")
  async updateCollection(@Param("collectionId") collectionId: number, @Body() name: string) {
  ...
  async collectionPlusPosting(@Param("collectionId") collectionId: number, @Param("postId") postId: number) {
  ...
  async collectionPlusRestaurant(@Param("collectionId") collectionId: number, @Param("restaurantId") restaurantId: number) {
  ...
  async collectionMinusPosting(@Param("collectionId") collectionId: number, @Param("postId") postId: number) {
  ...
  async collectionMinusRestaurant(@Param("collectionId") collectionId: number, @Param("restaurantId") restaurantId: number) {
