...
export declare class SchemaObjectFactory {
    ...
    createQueryOrParamSchema(param: ParamWithTypeMetadata, schemas: Record<string, SchemaObject>): ParameterObject[] | ParamWithTypeMetadata | Partial<ParamWithTypeMetadata & BaseParameterObject> | {
        type: string;
