...
let SocialNaverService = class SocialNaverService {
    constructor(configService, httpService) {
        ...
        this.clientId = this.configService.get('NAVER_CLIENTID');
        this.clientSecert = this.configService.get('NAVER_CLIENTSECRET');
        this.redirectUri = this.configService.get('NAVER_CALLBACKURL');
    }
    ...
    async getUserInfo(accessToken) {
        ...
        console.log('getUserInfo통과후response.data.response', response.data.response);
